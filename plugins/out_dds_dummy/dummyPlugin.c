    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),Dummy);
    if (sample == NULL) {
        return NULL;
    }

    if (!Dummy_initialize_w_params(sample,alloc_params)) {
...
DummyPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!Dummy_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        RTIOsapiHeap_freeStructure(sample);
        sample=NULL;
    }
...
{
    return DummyPluginSupport_create_data_ex(RTI_TRUE);
}
...
DummyPluginSupport_destroy_data_w_params(
    ...
    Dummy_finalize_w_params(sample,dealloc_params);
...
DummyPluginSupport_destroy_data_ex(
    ...
    Dummy_finalize_ex(sample,deallocate_pointers);
...
DummyPluginSupport_destroy_data(
    ...
    DummyPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
DummyPluginSupport_copy_data(
    ...
    const Dummy *src)
{
    return Dummy_copy(dst,(const Dummy*) src);
}
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        DummyPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = DummyPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            DummyPlugin_get_serialized_sample_max_size, epd,
...
DummyPlugin_return_sample(
    ...
    void *handle)
{
    Dummy_finalize_optional_members(sample, RTI_TRUE);
    ...
    const Dummy *src)
{
    ...
    return DummyPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    Dummy_get_typecode();
    pd.programs = DummyPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
DummyPlugin_serialize_to_cdr_buffer(
    ...
    const Dummy *sample)
{
    return DummyPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!DummyPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool DummyPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    Dummy **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *DummyPlugin_new(void) 
{ 
    ...
    DummyPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    DummyPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    Dummy_finalize_optional_members;
    ...
    DummyPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    DummyPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    DummyPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)Dummy_get_typecode();
    #endif
    ...
    DummyPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    DummyPlugin_return_buffer;
    ...
    plugin->endpointTypeName = DummyTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
DummyPlugin_delete(struct PRESTypePlugin *plugin)
{
