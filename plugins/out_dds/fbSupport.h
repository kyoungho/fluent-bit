...
#ifndef fbSupport_1282814908_h
#define fbSupport_1282814908_h
...
DDS_TYPESUPPORT_C(RecordTypeSupport, Record);
DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_C(RecordDataWriter, Record);
DDS_DATAREADER_C(RecordDataReader, RecordSeq, Record);
